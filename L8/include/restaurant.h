...
/*
    Purpose: to initialize and allocate memory for a Restaurant variable and return it to the calling function
...
/*
    ...
    Preconditions: two initialized Restaurant vaibles exist
    Postconditions: none
*/
